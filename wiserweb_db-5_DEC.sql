...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 05 2023 г., 09:56
...
(11, 'Serj Tankian', 'VIDEO', 'Monika/11_SOAD.mp4', 100),
...
(19, 'Alan Hovhaness', 'VIDEO', 'Monika/19_Alan_Hovaness.mp4', 100),
(20, 'Gabriel Kazanjian', 'IMG', 'Meri/20.jpg', 100),
...
(3, 'Which artist has depicted his mother in his favorite canvas and expressed genocide in art?<br>Որ նկարիչն է իր հայտնի կտավում պատկերել է մորը և արվեստում արտահայտել ցեղասպանությունը։', NULL, NULL, 100, 1, 3),
(4, 'His words are: \\\"Win as slowly as possible.\\\" He was a four-time Formula 1 champion. He was considered the best racer of his years. Who is it about?<br>Նրա խոսքերն են՝«Հաղթիր ինչքան հնարավոր է  դանդաղ»:Նա եղել է «Ֆորմուլա 1» մրցաշարի  քառակի չեմպիոն: Նա համարվել է իր տարիների լավագույն մրցարշավորդը: Ո՞ւմ մասին է խոսքը:', NULL, NULL, 100, -1, 4),
(5, 'I am Armenian in California, Armenian in London and in Yerevan. I am Armenian everywhere, I am the same person everywhere... I don’t write in Armenian but I look at the world in Armenian.<br>Ես Կալիֆորնիայում հայ եմ, Լոնդոնում հայ եմ, Երևանում հայ եմ։ Ես ամենտեղ հայ եմ և ամենտեղ նույն մարդն եմ... Ես հայերեն չեմ խոսում, բայց աշխարհին նայում եմ հայերեն։', NULL, NULL, 100, 2, 5),
(6, 'The American-Armenian businessman and philanthropist  is best known for investing millions into turning the crumbling Cascade site in Yerevan into a much loved park. Who is he?<br>Ամերիկահայ գործարարն ու բարերարն առավել հայտնի է նրանով, որ միլիոններ է ներդրել Երևանի փլուզվող Կասկադի տարածքը շատ սիրելի զբոսայգու վերածելու համար: Ով է նա?', NULL, NULL, 100, 3, 6),
(7, 'Which singer became the oldest woman to have a number one song at the age of 52?<br>Որ երգչուհին դարձավ 52 տարեկանում թիվ մեկ երգ ունեցող ամենատարեց կինը:', NULL, NULL, 100, 1, 7),
...
(9, 'Who is best known as the armenian nuclear physicist? Who is the researcher of superheavy chemical elements?<br>Ո՞վ առավել հայտնի է, որպես հայ միջուկային ֆիզիկոս։ Ո՞վ է գերծանր քիմիական տարրերի հետազոտողը:', NULL, NULL, 100, 2, 9),
...
(12, 'Who patented the invention of the kerosene lamp in Germany in 1984?<br>1894թ. ին ո՞վ է գերմանիայում արտոնագրեց կերոսինային լամպի գյուտը:', NULL, NULL, 100, -1, 12),
...
(14, 'Which Armenian star dictates her/his trends in the field of modern fashion?<br>Ազգությամբ հայ որ աստղն է ժամանակակից նորաձևության ոլորտում թելադրում իր միտումները:', NULL, NULL, 100, 3, 14),
(15, 'The producer who became famous thanks to the movie \\\"Star Wars\\\".<br>Պրոդյուսերը,որը հայտնի դարձավ \\\"Աստղային Պատերազմներ\\\" ֆիլմի շնորհիվ։', NULL, NULL, 100, 1, 15),
(16, 'Who is the diaspora-Armenian rich man who succeeded to occupy the second place in the list of the richest people in Argentina at the age of 81?<br>Ո՞վ է այն սփյուռքահայ մեծահարուստը, որին հաջողվում է 81 տարեկանում զբաղեցնել Արգենտինայի ամենահարուստ մարդկանց ցուցակում երկրորդ հորիզոնականը:', NULL, NULL, 100, -1, 16),
...
(19, 'Who is the author of these words \\\"I want to create a word of endless melody which would be healthy for the spirit\\\".<br>Ո՞վ է այս խոսքերը հեղինակը \\\"Ես ուզում եմ ստեղծել անվերջ մեղեդու մի խոսք, որը առողջարար կլինի ոգու համար\\\"։', NULL, NULL, 100, 1, 19),
...
(21, 'The world is really colorfull, it is not black and white, but the history of my people has always been two-colored, we need a lot of colors, so where else should the color television project be launched if not in Yerevan. Who is the author of these words?<br>Աշխարհն իսկապես գունեղ է, սև ու սպիտակ չէ, բայց իմ ժողովրդի պատմությունը միշտ եղել է երկգույն, մեզ շատ գույներ են պետք, ուրեմն էլ որտե՞ղ պետք է սկսել գունավոր հեռուստատեսության նախագիծը, եթե ոչ Երևանում։Ո՞վ է այս խոսքերի հեղինակը։', NULL, NULL, 100, 2, 21),
(22, 'During his career, the Armenian professional tennis player was recognized as the number one player in the world. He won 8 Grand Tournament games and Olympic Games. Who is it about?<br>Իր կարերայի ընթացքում հայ պրոֆեսիոնալ թենիսիստը ճանաչվել է աշխարհի առաջին ռակետ: Հաղթանակ է տարել Մեծ մրցաշարի 8 խաղերում և օլիմպիական խաղերում: Ո՞ւմ մասին է խոսքը:', NULL, NULL, 100, -1, 22),
...
(24, 'He was one of the innovative revolutionaries in the field of plastic surgery. Fleeing the Hamidian pogroms, he entered Harvard University and became the first professor of plastic surgery. He was called a \\\"magician\\\" by Sigmund Freud. Who is it about?<br>Նա եղել է պլաստիկ վիրաբուժության ասպարեզի նորարար հեղափոխականներից: Փախչելով համիդյան ջարդերից՝ ընդունվել է Հարվարդի համալսարան և դարձել պլաստիկ վիրաբուժության գծով առաջի  պրոֆեսորը: Զիգմունդ Ֆրոյդի կաղմից կոչվել է «հրաշագործ»: Ո՞ւմ մասին է խոսքը:', NULL, NULL, 100, -1, 24);
